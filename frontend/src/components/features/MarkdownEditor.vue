...
<template>
  <div
    class="border border-border-gray rounded-xl overflow-hidden flex flex-col flex-grow bg-white transition-all"
  >
    <div
      class="flex items-center gap-2 px-3 py-2 border-b border-border-gray bg-surface-container-lowest overflow-x-auto"
    >
      <div class="flex items-center gap-1 border-r border-border-gray pr-2 mr-1">
        <button
          :class="[
            ...
            activeFormats.includes('normal')
              ? 'bg-purple-subtle text-primary-container'
              : 'text-on-surface-variant hover:bg-surface-container hover:text-text-primary',
          ]"
          type="button"
        ...
        <button
          ...
          :class="[
            'font-semibold rounded-lg transition-colors flex items-center justify-center shrink-0 px-2.5 py-1 text-[13px] cursor-pointer active:scale-95',
            activeFormats.includes(btn.action)
              ? 'bg-purple-subtle text-primary-container'
              : 'text-on-surface-variant hover:bg-surface-container hover:text-text-primary',
          ]"
          type="button"
